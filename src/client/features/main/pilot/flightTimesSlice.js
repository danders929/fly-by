...
export const useGetFlightTimesQuery =
  flightTimesApi.endpoints.getflightTime.useQuery;
export const useUpdateFlightTimes =
  flightTimesApi.endpoints.updateFlightTime.useMutation;
export const useCreateFlightTimes =
  flightTimesApi.endpoints.createflightTime.useMutation;
...
const flightTimeSlice = createSlice({
  ...
  initialState: {
    ...
    dayFlight: true,
    flightDuration: 0.0,
    dayFlightDuration: 0.0,
    nightFlightDuration: 0.0,
  },
  reducers: {
...
export const {
  ...
  calculateDayFlightDuration,
  calculateNightFlightDuration,
} = flightTimeSlice.actions;
